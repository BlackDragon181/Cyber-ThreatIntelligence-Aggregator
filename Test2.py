...
Each factor = 10 points | Maximum Score = 120 points
        ...
        # Info Frame
        info_frame2 = ttk.LabelFrame(main_frame, text="Scoring Information", padding="10")
        info_frame2.grid(row=6, column=0, columnspan=3, sticky=(tk.W, tk.E), pady=10)
...
• Medium/Low (Below 65): Schedule for remediation
        """
        ttk.Label(info_frame2, text=info_text2, justify=tk.LEFT).grid(row=0, column=0, sticky=tk.W)
